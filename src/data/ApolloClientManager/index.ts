...
export class ApolloClientManager {
           ...
           return {
             data: {
               requiresConfirmation:
                 data?.accountRegister?.requiresConfirmation,
             },
           };
         };
         ...
         getRefreshedCheckoutLines = async (
           ...
           const linesWithProperVariantUpdated = linesWithProperVariant.map(
             line => {
                   ...
                   country:
                     CountryCode[
                       shippingAddress?.country
                         ?.code as keyof typeof CountryCode
                     ],
         ...
         createPayment = async ({
           ...
           try {
             ...
             if (data?.checkoutPaymentCreate?.payment) {
               return {
                 data: this.constructPaymentModel(
